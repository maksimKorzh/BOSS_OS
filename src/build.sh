...
dd seek=7 conv=notrunc if=new.bin of=BOSS.img
dd seek=8 conv=notrunc if=load.bin of=BOSS.img
dd seek=9 conv=notrunc if=source.bf of=BOSS.img

rm boot.bin shell.bin brainfuck.bin view.bin save.bin edit.bin new.bin load.bin
